...
socket.on( 'current-status', ( payload ) => {
    ...
    if ( ticket1 ) {
        lblTicket1.innerText = 'Ticker ' + ticket1.number;
        lblEscritorio1.innerText = ticket1.desk;
    } 
    
    if ( ticket2 ) {
        lblTicket2.innerText = 'Ticker ' + ticket2.number;
        lblEscritorio2.innerText = ticket2.desk;
    }

    if ( ticket3 ) {
        lblTicket3.innerText = 'Ticker ' + ticket3.number;
        lblEscritorio3.innerText = ticket3.desk;
    }

    if ( ticket4 ) {
        lblTicket4.innerText = 'Ticker ' + ticket4.number;
